...
export default async function Navbar() {
  ...
  return (
    <nav className="sticky top-0 z-50 bg-[#E8E7E5]/95 dark:bg-[#163A7A]/95 backdrop-blur-md text-primary border-b border-primary/5">
      <div className="max-w-7xl mx-auto px-6 lg:px-12">
        <div className="flex justify-between items-center h-28">
          <div className="flex items-center space-x-12">
            <Link href="/" className="flex items-center justify-center w-36 md:w-48 h-12 relative overflow-hidden hover:opacity-80 transition-opacity">
          ...
          <div className="flex items-center space-x-8 text-sm font-medium tracking-wide">
            ...
            <div className="flex items-center space-x-4 md:space-x-6">
              <Link href="/cart" className="hover:opacity-70 md:hidden" aria-label="Cart">
