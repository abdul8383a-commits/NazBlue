  ...
  return (
    <div className="max-w-7xl mx-auto px-6 lg:px-12 py-16 min-h-[70vh]">
      <div className="mb-12 border-b border-primary/10 pb-6">
        <h1 className="text-4xl font-serif tracking-tight text-primary">Kids</h1>
        <p className="mt-4 text-primary/70 max-w-xl">Everyday essentials crafted for the little ones.</p>
      </div>
