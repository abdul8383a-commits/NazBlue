...
export default function Signup() {
  ...
  return (
    <div className="flex flex-col items-center justify-center py-20 px-4 min-h-[90vh] bg-gray-50/50 dark:bg-transparent">
      <div className="w-full max-w-lg p-8 sm:p-10 bg-white dark:bg-gray-900/50 backdrop-blur-xl border border-gray-100 dark:border-white/10 rounded-3xl shadow-2xl shadow-primary/5 dark:shadow-none transition-all duration-300">
            ...
            <div className="space-y-1">
              ...
              <div className="relative">
                ...
                <input 
                  ...
                  className={`block w-full pl-10 pr-3 py-2.5 border rounded-xl bg-gray-50 dark:bg-gray-800/50 text-gray-900 dark:text-white placeholder-gray-400 focus:outline-none focus:ring-2 sm:text-sm transition-colors ${
          ...
          <div className="space-y-1">
            ...
            <div className="relative">
              ...
              <input 
                ...
                className={`block w-full pl-10 pr-10 py-2.5 border rounded-xl bg-gray-50 dark:bg-gray-800/50 text-gray-900 dark:text-white placeholder-gray-400 focus:outline-none focus:ring-2 sm:text-sm transition-colors ${
        ...
        <div className="mt-8">
          ...
          <div className="mt-6">
            <button 
              ...
              className="w-full flex items-center justify-center space-x-2 border border-gray-200 dark:border-white/10 py-2.5 px-4 rounded-xl shadow-sm bg-gray-50 dark:bg-gray-800/50 hover:bg-gray-50 dark:hover:bg-gray-800 text-sm font-medium text-gray-700 dark:text-gray-200 transition-all duration-200"
            >
